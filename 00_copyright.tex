...
\begin{center}
  ...
  \textit{Copyright © 2025 by Sebastián Bobadilla Suárez}

  Some rights reserved. This work is licensed to promote open academic discourse while protecting intellectual property rights. Readers are granted permission to: 1) quote, cite and refer to this work in academic and scholarly contexts with appropriate attribution, 2) use figures, tables, and excerpts for educational purposes with appropriate citation, 3) share and discuss the ideas presented herein in academic discourse and reviews, and 4) create derivative works that build upon these ideas in scholarly contexts.
