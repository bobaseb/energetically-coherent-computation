...
\SetWatermarkText{DRAFT - Sebastián Bobadilla Suárez - v0.5.1}  % Replace with your name and version
...
% Remove page numbers from lists in TOC
\cftpagenumbersoff{figure}
\cftpagenumbersoff{table}
\cftpagenumbersoff{myequations}
...
\addbibresource{references/0001_5_new_anthro.bib}
\addbibresource{references/0001_6_artificial_systems.bib}
\addbibresource{references/0001_7_other_theories.bib}
\addbibresource{references/0001_8_future_dirs.bib}
\addbibresource{references/0001_9_critique.bib}
\addbibresource{references/0001_10_appendices.bib}

\graphicspath{{images/}}

\makeindex[title=,options=-s lix.ist -n]
...
\input{03_foundations}

%TODO: somewhere we should mention that ECC obliterates the typical computational stance that embodiment critiques just require better input/environment simulations for the computational agent

\section*{\phantom{Part IV Theoretical Framework}}
\input{04_framework}

\section*{\phantom{Part V Biological Implementation}}
\input{05_bio_implementation}

\section*{\phantom{Part VI Biological and Psychological Implications}}
\input{06_bio_psycho_implications}

\section*{\phantom{Part VII Anthropological Implications}}
\input{07_anthropology}

\section*{\phantom{Part VIII Artificial Systems}}
\input{08_artificial_systems}

\section*{\phantom{Part IX Comparative Analysis}}
\input{09_other_theories}

\section*{\phantom{Part X Future Directions}}
\input{10_future_directions}
